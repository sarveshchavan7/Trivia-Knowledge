...
public class SportsAdapter extends ArrayAdapter<String> {
    ...
    public SportsAdapter(Activity context, Integer[] img, String[] s/*, String[] strings*/) {
        super(context, R.layout.gv_sports_grid_view, s);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.gv_sports_grid_view,null, true);
