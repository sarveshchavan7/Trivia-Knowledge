...
import sarveshchavan777.inrerface2.Tab.ArtsGk.ArtsGkEasyTab;
import sarveshchavan777.inrerface2.Tab.ArtsGk.ArtsGkHardTab;
import sarveshchavan777.inrerface2.Tab.ArtsGk.ArtsGkMediumTab;


public class MyPagerAdapterArts extends FragmentPagerAdapter {
    Context context;
    ...
    public MyPagerAdapterArts(FragmentManager fm, int micon[], int mNumOfTabs, Context context) {
        super(fm);
