...
*/
    ...
    /*    ImageView imageViewsArray[]={p1,p2,p3,p4};
        ...
        //phy
        TextView array1[]={text9,text18,text32,text34,text40,text41,text48,text52,text57};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(phy);
            array1[i].setTypeface(typeface2);
        }
        //chem
        TextView array2[]={text1,text4,text6,text7,text7,text17,text21,text24,text25,text27,text28,text29,text30,text31,text46,text47,text55,text56,text58};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(chem);
            array2[i].setTypeface(typeface2);
        }
        //bio
        TextView array3[]={text2,text10,text13,text14,text36,text37,text49,text53,text59};
        for(int i=0;i<array3.length;i++){
            array3[i].setText(bio);
            array3[i].setTypeface(typeface2);
        }
        //maths
        TextView array4[]={text3,text12,text23};
        for(int i=0;i<array4.length;i++){
            array4[i].setText(maths);
            array4[i].setTypeface(typeface2);
        }
        //sci
        TextView array5[]={text8,text11,text15,text16,text19,text20,text22,text26,text33,text35,
                text42,text43,text44,text45,text50,text51,text54,text60};
        for(int i=0;i<array5.length;i++){
            array5[i].setText(sci);
            array5[i].setTypeface(typeface2);
        }
        //tech
        TextView array6[]={text5,text38,text39};
