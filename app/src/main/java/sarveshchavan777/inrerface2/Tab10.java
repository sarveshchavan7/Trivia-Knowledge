...
public class Tab10 extends Fragment  {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        p61= (TextView) getView().findViewById(R.id.p61);
        p62= (TextView) getView().findViewById(R.id.p62);
        p63= (TextView) getView().findViewById(R.id.p63);
        p64= (TextView) getView().findViewById(R.id.p64);
        p65= (TextView) getView().findViewById(R.id.p65);
        p66= (TextView) getView().findViewById(R.id.p66);
        p67= (TextView) getView().findViewById(R.id.p67);
        p68= (TextView) getView().findViewById(R.id.p68);
        p69= (TextView) getView().findViewById(R.id.p69);
        p70= (TextView) getView().findViewById(R.id.p70);
        p71= (TextView) getView().findViewById(R.id.p71);
        p72= (TextView) getView().findViewById(R.id.p72);
        p73= (TextView) getView().findViewById(R.id.p73);
        p74= (TextView) getView().findViewById(R.id.p74);
        p75= (TextView) getView().findViewById(R.id.p75);
        p76= (TextView) getView().findViewById(R.id.p76);
        p77= (TextView) getView().findViewById(R.id.p77);
        p78= (TextView) getView().findViewById(R.id.p78);
        p79= (TextView) getView().findViewById(R.id.p79);
        p80= (TextView) getView().findViewById(R.id.p80);
        ...
        t61=(ImageView)getView().findViewById(R.id.tick61);
        t62=(ImageView)getView().findViewById(R.id.tick62);
        t63=(ImageView)getView().findViewById(R.id.tick63);
        t64=(ImageView)getView().findViewById(R.id.tick64);
        t65=(ImageView)getView().findViewById(R.id.tick65);
        t66=(ImageView)getView().findViewById(R.id.tick66);
        t67=(ImageView)getView().findViewById(R.id.tick67);
        t68=(ImageView)getView().findViewById(R.id.tick68);
        t69=(ImageView)getView().findViewById(R.id.tick69);
        t70=(ImageView)getView().findViewById(R.id.tick70);
        t71=(ImageView)getView().findViewById(R.id.tick71);
        t72=(ImageView)getView().findViewById(R.id.tick72);
        t73=(ImageView)getView().findViewById(R.id.tick73);
        t74=(ImageView)getView().findViewById(R.id.tick74);
        t75=(ImageView)getView().findViewById(R.id.tick75);
        t76=(ImageView)getView().findViewById(R.id.tick76);
        t77=(ImageView)getView().findViewById(R.id.tick77);
        t78=(ImageView)getView().findViewById(R.id.tick78);
        t79=(ImageView)getView().findViewById(R.id.tick79);
        t80=(ImageView)getView().findViewById(R.id.tick80);
        ...
        text61=(TextView) getView().findViewById(R.id.text61);
        text62=(TextView) getView().findViewById(R.id.text62);
        text63=(TextView) getView().findViewById(R.id.text63);
        text64=(TextView) getView().findViewById(R.id.text64);
        text65=(TextView) getView().findViewById(R.id.text65);
        text66=(TextView) getView().findViewById(R.id.text66);
        text67=(TextView) getView().findViewById(R.id.text67);
        text68=(TextView) getView().findViewById(R.id.text68);
        text69=(TextView) getView().findViewById(R.id.text69);
        text70=(TextView) getView().findViewById(R.id.text70);

        text71=(TextView) getView().findViewById(R.id.text71);
        text72=(TextView) getView().findViewById(R.id.text72);
        text73=(TextView) getView().findViewById(R.id.text73);
        text74=(TextView) getView().findViewById(R.id.text74);
        text75=(TextView) getView().findViewById(R.id.text75);
        text76=(TextView) getView().findViewById(R.id.text76);
        text77=(TextView) getView().findViewById(R.id.text77);
        text78=(TextView) getView().findViewById(R.id.text78);
        text79=(TextView) getView().findViewById(R.id.text79);
        text80=(TextView) getView().findViewById(R.id.text80);
...
*/
    ...
    final   List  list11=new ArrayList();
        ...
        //@@ put imageview till 40
    /*    ImageView imageViewsArray[]={p1,p2,p3,p4};
        ...
        TextView imageViewsArray[]={p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31,p32,p33,p34,p35,p36,p37,p38,p39,p40,
                p41,p42,p43,p44,p45,p46,p47,p48,p49,p50,p51,p52,p53,p54,p55,p56,p57,p58,p59,p60,p61,p62,p63,p64,p65,p66,p67,p68,p69,p70,p71,p72,p73,p74,p75,p76,p77,p78,p79,p80};
        for(int i=0;i<imageViewsArray.length;i++){
            final int finalI=i+360;
            imageViewsArray[i].setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(getActivity(),Personality.class);
        ...
        easyPerScoreText.setText(list.size() + "/" + 80);
        ...
        //landmark
        TextView array1[]={text1,text6,text11,text16,text21,text29,text37,text41,text46,text57,text64,text70,text71,text77};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(landmark);
            array1[i].setTypeface(typeface2);
        }
        //geo
        TextView array2[]={text3,text8,text15,text18,text19,text20,text23,text27,text31,text34,text36,text38,text40,text48,text51,text53,text54,text59,text62,text63,text67,text74,text78,text80};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(geo);
            array2[i].setTypeface(typeface2);
        }
        //mountain
        TextView array3[]={text4,text9,text14,text24,text32,text44,text49,text55,text61,text68,text76};
        for(int i=0;i<array3.length;i++){
            array3[i].setText(mountain);
            array3[i].setTypeface(typeface2);
        }
        //river
        TextView array4[]={text5,text50,text56};
        for(int i=0;i<array4.length;i++){
            array4[i].setText(river);
            array4[i].setTypeface(typeface2);
        }
        //ocean
        TextView array5[]={text10,text25,text33,text45,text66,text69,text75,text79};
        for(int i=0;i<array5.length;i++){
            array5[i].setText(ocean);
            array5[i].setTypeface(typeface2);
        }
        //space
        TextView array6[]={text13,text26,text60};
        for(int i=0;i<array6.length;i++){
            array6[i].setText(space);
            array6[i].setTypeface(typeface2);
        }
        //desert
        TextView array7[]={text43};
        for(int i=0;i<array7.length;i++){
            array7[i].setText(desert);
            array7[i].setTypeface(typeface2);
        }
        //capital
        TextView array8[]={text2,text7,text12,text17,text22,text28,text30,text35,text39,text42,text47,text52,text58,text65,text72,text73};
        for(int i=0;i<array8.length;i++){
            array8[i].setText(capital);
