...
public class Tab9 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab09, container, false);
        return v;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      //  unlock=(TextView)getView().findViewById(R.id.unlock);
        ...
        //football
        TextView array1[]={text1,text4,text10,text16,text21,text25,text33,text34,text36,text37,text38,text39,text40,text42,text43,text44,text53};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(football);
            array1[i].setTypeface(typeface2);
        }
        //olympic
        TextView array2[]={text2,text6,text7,text8,text9,text14,text19,text54};
        ...
        //sports
        TextView array5[]={text5,text12,text13,text15,text23,text26,text30,text32,text35,text5,text46,text55,text56,text57,text59};
        ...
        //cricket
        TextView array7[]={text11,text22,text24,text27,text49};
        ...
        //tennis
        TextView array21[]={text52,text17,text18,text50};
