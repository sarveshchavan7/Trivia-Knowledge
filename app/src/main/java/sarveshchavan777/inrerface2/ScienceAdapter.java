...
class ScienceAdapter extends ArrayAdapter<String> {
    ...
    ScienceAdapter (Activity context, Integer[] img, String[] s/*, String[] strings*/) {
        super(context, R.layout.sci_grid_view, s);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.sci_grid_view,null, true);
