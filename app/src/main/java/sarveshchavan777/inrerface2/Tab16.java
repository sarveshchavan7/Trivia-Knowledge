...
public class Tab16 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab16, container, false);
        return v;
    }
...
*/
    ...
    /*    ImageView imageViewsArray[]={p1,p2,p3,p4};
        ...
        easyPerScoreText.setText(list.size() + "/" + 40);
        ...
        //arts
        TextView array1[]={text1,text2,text11,text13,text16,text19,text20,text23,text26,text33,
                text35,text36,text37,text38,text40};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(arts);
            array1[i].setTypeface(typeface2);
        }
        //gk
        TextView array2[]={text3,text4,text5,text6,text7,text8,text9,text10,text12,text14,
                text15,text17,text18,text21,text22,text24,text25,text27,text28,text29,
                text30,text31,text32,text34,text39};
