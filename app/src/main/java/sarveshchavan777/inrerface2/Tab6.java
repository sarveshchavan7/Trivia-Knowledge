...
public class Tab6 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab06, container, false);
        return v;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
     ...
     //   unlock=(TextView)getView().findViewById(R.id.unlock);
        ...
        //personality
        TextView array1[]={text1,text5,text10,text23,text30,text37,text40,text41,text43,text50,text52,text53,text57,text59,text60};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(politician);
            array1[i].setTypeface(typeface2);
        }
        //entrepreneur
        TextView array2[]={text2,text7,text21,text26,text38,text24,text27};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(entrepreneur);
            array2[i].setTypeface(typeface2);
        }
        //scientist
        TextView array3[]={text3,text8,text12,text17,text19};
        for(int i=0;i<array3.length;i++){
            array3[i].setText(scientist);
            array3[i].setTypeface(typeface2);
        }
        //singer
        TextView array4[]={text4,text16,text22,text32,text39,text46};
        for(int i=0;i<array4.length;i++){
            array4[i].setText(singer);
            array4[i].setTypeface(typeface2);
         //   array4[i].setTextSize(9);
        }
        //actor
        TextView array5[]={text9,text14,text20,text55};
        for(int i=0;i<array5.length;i++){
            array5[i].setText(actor);
            array5[i].setTypeface(typeface2);
        }
        //sportsperson
        TextView array6[]={text6,text34};
        for(int i=0;i<array6.length;i++){
            array6[i].setText(sportsperson);
            array6[i].setTypeface(typeface2);
        }
        //astronaut
        TextView array7[]={text25,text56};
        for(int i=0;i<array7.length;i++){
            array7[i].setText(astronaut);
            array7[i].setTypeface(typeface2);
        }
        //actress
        TextView array8[]={text13,text15,text28,text47,text51};
        ...
        //programmer
        TextView array17[]={text11,text44,text48};
