...
class PersonalityAdapter extends ArrayAdapter<String> {
    ...
    PersonalityAdapter(Activity context, Integer[] img, String[] s, String[] strings) {
        super(context, R.layout.per_grid_view, s);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.per_grid_view,null, true);
