...
class ArtsAdapter extends ArrayAdapter<String> {
    ...
    ArtsAdapter(Activity context, Integer[] img, String[] s, String[] strings) {
        super(context, R.layout.arts_grid_view, s);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.arts_grid_view,null, true);
