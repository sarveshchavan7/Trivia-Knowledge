...
public class Tab19 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab19, container, false);
        return v;
    }
...
*/
    ...
    /*    ImageView imageViewsArray[]={p1,p2,p3,p4};
        ...
        //music
        TextView array1[]={text1,text5,text6,text10,text11,text12,text20,text22,text23,text24,
                text25,text26,text27,text28,text29,text30,text33,text37,text39,text42,
                text46,text48,text49,text50,text51,text52,text60,text68,text69,text70,
        text71,text72,text75,text76};
        for(int i=0;i<array1.length;i++){
         array1[i].setText(music);
         array1[i].setTypeface(typeface2);
        }
        //movie_film
        TextView array2[]={text2,text3,text15,text16,text18,text19,text21,text31,text32,text34,
                text35,text36,text41,text47,text53,text54,text55,text58,text59,text62,
                text63,text64,text65,text66,text79};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(movie_film);
            array2[i].setTypeface(typeface2);
        }
        //superhero
        TextView array3[]={text4,text7,text9,text13,text17,text38,text43,text56,text57,text61,text80};
        for(int i=0;i<array3.length;i++){
            array3[i].setText(superhero);
            array3[i].setTypeface(typeface2);
        }
        //catoon_manga
        TextView array4[]={text8,text14,text44,text67,text73,text74,text78};
        for(int i=0;i<array4.length;i++){
            array4[i].setText(cartoon_manga);
            array4[i].setTypeface(typeface2);
        }
        //entertainment
        TextView array5[]={text40,text45,text77};
