...
import sarveshchavan777.inrerface2.Tab.Entertainment.EnterEasyTab;
import sarveshchavan777.inrerface2.Tab.Entertainment.EnterHardTab;
import sarveshchavan777.inrerface2.Tab.Entertainment.EnterMediumTab;


public class MyPagerAdapterEntertainment extends FragmentStatePagerAdapter {
    Context context;
   ...
   private int numbOfTabs; // Store the number of tabs, this will also be passed when the ViewPagerAdapter is created
     ...
     public MyPagerAdapterEntertainment(FragmentManager fm, int micon[], int mNumOfTabs, Context context) {
        super(fm);
