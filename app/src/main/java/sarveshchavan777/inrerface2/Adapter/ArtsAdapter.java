...
public class ArtsAdapter extends ArrayAdapter<String> {
    ...
    public ArtsAdapter(Activity context, Integer[] img, String[] s/*, String[] strings*/) {
        super(context, R.layout.gv_arts_grid_view, s);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.gv_arts_grid_view,null, true);
