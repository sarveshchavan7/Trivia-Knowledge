...
public class Tab18 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab18, container, false);
        return v;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        hardPerScoreText.setText(list.size() + "/" + 40);
        ...
        //arts
        TextView array1[]={text1,text2,text3,text4,text5,text7,text9,text13,text15,text17,
                text18,text19,text21,text23,text24,text25,text26,text28,text29,text30,
                text32,text33,text35,text36,text37,text40};
        ...
        //gk
        TextView array2[]={text6,text8,text10,text11,text12,text14,text16,text20,text22,text27,text31,text34,text38,text39};
