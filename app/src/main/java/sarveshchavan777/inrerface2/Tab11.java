...
public class Tab11 extends Fragment  {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      //  unlock=(TextView)getView().findViewById(R.id.unlock);
        ...
        mediumPerScoreText.setText(list.size() + "/" + 80);
        ...
        //landmark
        TextView array1[]={text1,text11,text15,text27,text34,text35,text41,text67,text75,text76};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(landmark);
            array1[i].setTypeface(typeface2);
        }
        //geo
        TextView array2[]={text6,text17,text18,text19,text21,text22,text23,text25,text31,text32,
                text33,text39,text42,text45,text46,text47,text49,text50,text51,text57,
                text58,text61,text66,text69,text71,text74,text78,text79};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(geo);
            array2[i].setTypeface(typeface2);
        }
        //mountain
        TextView array3[]={text3,text9,text14,text16,text36,text48,text52,text53,text54,text62,text63,text64,text72,text73};
        for(int i=0;i<array3.length;i++){
            array3[i].setText(mountain);
            array3[i].setTypeface(typeface2);
        }
        //river
        TextView array4[]={text4,text5,text10,text29,text38,text40,text60,};
        for(int i=0;i<array4.length;i++){
            array4[i].setText(river);
            array4[i].setTypeface(typeface2);
        }
        //ocean
        TextView array5[]={text24,text37};
        for(int i=0;i<array5.length;i++){
            array5[i].setText(ocean);
            array5[i].setTypeface(typeface2);
        }
        //space
        TextView array6[]={text8};
        for(int i=0;i<array6.length;i++){
            array6[i].setText(space);
            array6[i].setTypeface(typeface2);
        }
        //desert
        TextView array7[]={text13,text44,text59};
        for(int i=0;i<array7.length;i++){
            array7[i].setText(desert);
            array7[i].setTypeface(typeface2);
        }
        //capital
        TextView array8[]={text2,text7,text12,text20,text26,text28,text30,text43,text55,text56,
                text65,text68,text70,text77,text80};
