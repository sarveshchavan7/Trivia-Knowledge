...
public class PersonalityAdapter extends ArrayAdapter<String> {
   ...
   // private final String[] strings;
    ...
    public PersonalityAdapter(Activity context, Integer[] img, String[] s/*,String[] strings*/) {
        super(context, R.layout.gv_per_grid_view, s);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.gv_per_grid_view,null, true);
