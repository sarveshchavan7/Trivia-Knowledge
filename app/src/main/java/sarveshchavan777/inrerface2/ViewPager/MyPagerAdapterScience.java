...
import sarveshchavan777.inrerface2.Tab.Science.ScienceEasyTab;
import sarveshchavan777.inrerface2.Tab.Science.ScienceHardTab;
import sarveshchavan777.inrerface2.Tab.Science.ScienceMediumTab;


public class MyPagerAdapterScience extends FragmentStatePagerAdapter {
    Context context;
  ...
  private   int numbOfTabs; // Store the number of tabs, this will also be passed when the ViewPagerAdapter is created
     ...
     public MyPagerAdapterScience(FragmentManager fm, int micon[], int mNumOfTabs, Context context) {
        super(fm);
