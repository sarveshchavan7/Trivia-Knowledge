...
public class Tab12 extends Fragment  {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
       ...
       hardPerScoreText.setText(list.size() + "/" + 80);
        ...
        //landmark
        TextView array1[]={text12,text13,text39,text55,text69,text79};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(landmark);
            array1[i].setTypeface(typeface2);
        }
        //geo
        TextView array2[]={text1,text4,text7,text9,text10,text14,text16,text18,text19,text21,
                text23,text26,text27,text32,text41,text43,text44,text46,text47,text51,
                text52,text53,text54,text57,text58,text59,text61,text62,text63, text64,
                text67,text68,text70,text71,text72,text73,text74,text77};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(geo);
            array2[i].setTypeface(typeface2);
        }
        //mountain
        TextView array3[]={text2,text3,text29};
        for(int i=0;i<array3.length;i++){
            array3[i].setText(mountain);
            array3[i].setTypeface(typeface2);
        }
        //river
        TextView array4[]={text36,text50};
        for(int i=0;i<array4.length;i++){
            array4[i].setText(river);
            array4[i].setTypeface(typeface2);
        }
        //ocean
        TextView array5[]={text15,text31,text48,text65};
        for(int i=0;i<array5.length;i++){
            array5[i].setText(ocean);
            array5[i].setTypeface(typeface2);
        }
        //space
        TextView array6[]={text42,text76,text78,text80};
        ...
        //capital
        TextView array8[]={text5,text6,text8,text11,text17,text20,text22,text24,text25,text28,
                text30,text33,text34,text35,text37,text38,text40,text45,text49,text56,
                text60,text66,text75};
