...
*/
    ...
    /*    ImageView imageViewsArray[]={p1,p2,p3,p4};
        ...
        //football
        TextView array1[]={text1,text4,text6,text10,text21,text23,text24,text29,text33,text35,text36,
                text44,text45,text48,text52,text57};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(football);
            array1[i].setTypeface(typeface2);
        }
        //olympic
        TextView array2[]={text2,text11,text25,text28,text30,text34,text38};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(olympic);
            array2[i].setTypeface(typeface2);
        }
        //wrestling
        TextView array3[]={text3};
        ...
        //sports
        TextView array5[]={text7,text9,text12,text13,text16,text17,text18,text20,text31,text43,text47,text50,text51,text53,text58,text59,text60};
