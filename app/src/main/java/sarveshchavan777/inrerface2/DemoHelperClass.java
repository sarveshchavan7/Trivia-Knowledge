...
public class DemoHelperClass extends SQLiteOpenHelper {
   ...
   /* static String TABLE_NAME7 = "TRIVIAQUIZ7";
    ...
    void addquestions() {
        ...
        allQuestions.add(new Questions("Who is the 45th & current President of the United States ?\nHint: Before entering politics he was a businessman and television personality.", "DONALD", "TRUMP", "QOMRADLAD", "UFTWCEYNP", "EQWYFCA"));
        ...
        allQuestions.add(new Questions("Famous personality & the founder of ‘Marxism’ often swallowed opium to overcome the pain he endured due to his liver problems, Name him.", "KARL", "MARX", "NDLTXAR", "ARJXQMK", "QNDJXT"));
        ...
        allQuestions.add(new Questions("An American model, actress, and television personality. \"______ ______ Smith\" first gained popularity in Playboy, winning the title of 1993 Playmate of the Year.", "ANNA", "NICOLE", "CNNICKVO", "NLOQAEAV", "VKCOQV"));
        ...
        allQuestions.add(new Questions("What is the unit for measuring the amplitude of a sound ?", "DECIBEL", "", "KIYDLBW", "LEVECAX", "WYAXVLK"));
        ...
        allQuestions.add(new Questions("Loudness of sound depends upon ______ of sound wave.", "Amplitude", "", "HEWTULAT", "GDEGMIGP", "TWGGGEH"));
        ...
        allQuestions.add(new Questions("The first atomic bomb ever used in war-time was dropped on what city of japan ?", "Hiroshima", "", "CROVIHRL", "AHKASITM", "ATVRLKC"));
        ...
        allQuestions.add(new Questions("What 2013 film is about the mid-orbit destruction of a space shuttle and the attempts to return home ?", "Gravity", "", "AVRXVPG", "HKJBYTI", "HVXBKJP"));
        ...
        allQuestions.add(new Questions("Name the film about a WWII American Army Medic who becomes the first man in American history to receive the Medal of Honor without firing a shot.", "Hacksaw", "Ridge", "ITKAESBWR", "DVCARKHGS", "RTSVKB"));
        ...
        allQuestions.add(new Questions("U2's \"Angel of Harlem\" was written about which singer ?", "Billie", "Holiday", "IDBOMIHYO", "AALEHBLIL", "OABMH"));
        ...
        //entertainment hard
        allQuestions.add(new Questions("What movie is about the first American cargo ship to be hijacked in 200 years ?", "Captain", "Phillips", "PPITPHSPI", "AOLCWILNA", "OWP"));
