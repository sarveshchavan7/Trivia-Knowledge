...
public class Tab20 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab20, container, false);
        return v;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
       ...
       // unlock=(TextView)getView().findViewById(R.id.unlock);
        ...
        //music
        TextView array1[]={text1,text3,text5,text6,text7,text8,text10,text11,text12,text14,
                text15,text16,text17,text21,text22,text23,text24,text25,text26,text28,
                text32,text34,text35,text36,text39,text41,text42,text43,text48,text49,
                text50,text51,text52,text56,text57,text61,text71,text72,text74,text77,
                text79,text80};
        ...
        //movie_film
        TextView array2[]={text4,text31,text37,text38,text45,text53,text54,text55,text58,text59,
                text60,text62,text63,text65,text66,text67,text69,text73};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(movie_film);
            array2[i].setTypeface(typeface2);
        }
        //superhero
        TextView array3[]={text2,text19,text44,text70,text75,text78};
        for(int i=0;i<array3.length;i++){
            array3[i].setText(superhero);
            array3[i].setTypeface(typeface2);
        }
        //catoon_manga
        TextView array4[]={text9,text13,text27,text30,text40,text64,text68,text76};
        for(int i=0;i<array4.length;i++){
            array4[i].setText(cartoon_manga);
            array4[i].setTypeface(typeface2);
        }
        //entertainment
        TextView array5[]={text18,text20,text29,text33,text46,text47};
