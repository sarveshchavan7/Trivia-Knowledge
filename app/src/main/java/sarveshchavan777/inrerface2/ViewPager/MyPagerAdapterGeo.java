...
import sarveshchavan777.inrerface2.Tab.Geography.GeoEasyTab;
import sarveshchavan777.inrerface2.Tab.Geography.GeoHardTab;
import sarveshchavan777.inrerface2.Tab.Geography.GeoMediumTab;


public class MyPagerAdapterGeo extends FragmentStatePagerAdapter {
    Context context;
   ...
   public MyPagerAdapterGeo(FragmentManager fm, int micon[], int mNumOfTabs, Context context) {
        super(fm);
