...
class MyPageerAdapterEntertainment extends FragmentStatePagerAdapter {
    Context context;
    ...
    public MyPageerAdapterEntertainment(FragmentManager fm, int micon[], int mNumOfTabs, Context context) {
        super(fm);
