...
public class GeoAdapter extends ArrayAdapter<String> {
   ...
   // private final String[] strings;
    ...
    public GeoAdapter(Activity context, Integer[] img, String[] s/*, String[] strings*/) {
        super(context, R.layout.gv_geo_grid_view, s);
