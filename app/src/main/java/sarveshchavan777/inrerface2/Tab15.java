...
public class Tab15 extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab15, container, false);
        return v;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      //  unlock=(TextView)getView().findViewById(R.id.unlock);
        ...
        //phy
        TextView array1[]={text7,text8,text12,text13,text14,text16,text19,text27,text52,text36};
        for(int i=0;i<array1.length;i++){
            array1[i].setText(phy);
            array1[i].setTypeface(typeface2);
        }
        //chem
        TextView array2[]={text2,text3,text4,text11,text20,text21,text22,text23,text24,text25,
                text26,text28,text31,text32,text33,text34,text35,text37,text38,text39,
                text40,text41,text44,text46,
                text48,text54,text55,text56,text58,text60};
        for(int i=0;i<array2.length;i++){
            array2[i].setText(chem);
            array2[i].setTypeface(typeface2);
        }
        //bio
        TextView array3[]={text1,text5,text6,text9,text29,text30,text42,text43,text47,text51,
        text53,text57,text59};
        ...
        //sci
        TextView array5[]={text10,text13,text15,text17,text18,text45,text49,text50};
