package sarveshchavan777.inrerface2.Google.GoogleInAppBilling;
...
public class InAppPurchase extends Activity implements IabBroadcastReceiver.IabBroadcastListener {
   ...
   /* public InAppPurchase(Context context) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.a_in_app_purchase);
...
//              }
        ...
        mHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
            public void onIabSetupFinished(IabResult result) {
                ...
                // Important: Dynamically register for broadcast messages a_about updated purchases.
    ...
    /*public void buyed(View view) {
        ...
        MainGameActivity.diamondtext.setText(Integer.toString(totalGems));
    }*/
